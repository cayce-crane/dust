...
# List of nakeds for use by characters and clothing
NAKEDS_LIST = ['head', 'left-eye', 'right-eye', 'face', 'neck', 'left-shoulder', 'right-shoulder', 'chest', 'back',
               'left-upperarm', 'right-upperarm', 'left-forearm', 'right-forearm', 'left-hand', 'right-hand',
               'abdomen', 'groin', 'butt', 'left-thigh', 'right-thigh', 'left-calf', 'right-calf',
